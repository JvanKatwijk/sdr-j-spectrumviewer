...
DISTDIR = /usr/shared/sdr-j-spectrumviewer/.tmp/sdr-j-spectrumviewer1.0.0
LINK          = g++
...
SOURCES       = src/main.cpp \
		...
		input/airspy/airspy-handler.cpp moc_gui.cpp \
		moc_scope.cpp \
...
DIST          = ../../lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		input/airspy/airspy-handler.h src/main.cpp \
		src/gui.cpp \
		src/fft.cpp \
		src/scope.cpp \
		input/virtual-input.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents includes/gui.h includes/spectrum-constants.h includes/fft.h includes/ringbuffer.h includes/spectrogramdata.h includes/scope.h input/virtual-input.h input/dabstick/dabstick.h input/dabstick/dongleselect.h input/sdrplay/sdrplay.h input/sdrplay/sdrplay-loader.h input/sdrplay/sdrplay-worker.h input/airspy/airspy-handler.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/gui.cpp src/fft.cpp src/scope.cpp input/virtual-input.cpp input/dabstick/dabstick.cpp input/dabstick/dongleselect.cpp input/sdrplay/sdrplay.cpp input/sdrplay/sdrplay-loader.cpp input/sdrplay/sdrplay-worker.cpp input/airspy/airspy-handler.cpp $(DISTDIR)/
	$(COPY_FILE) --parents sdrgui.ui input/dabstick/dabstick-widget.ui input/sdrplay/sdrplay-widget.ui input/airspy/airspy-widget.ui $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_gui.cpp moc_scope.cpp moc_virtual-input.cpp moc_dabstick.cpp moc_dongleselect.cpp moc_sdrplay.cpp moc_sdrplay-worker.cpp moc_airspy-handler.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_gui.cpp moc_scope.cpp moc_virtual-input.cpp moc_dabstick.cpp moc_dongleselect.cpp moc_sdrplay.cpp moc_sdrplay-worker.cpp moc_airspy-handler.cpp
...
sdrplay-worker.o: input/sdrplay/sdrplay-worker.cpp includes/spectrum-constants.h \
		../../include/math.h \
		../../include/features.h \
		../../include/stdc-predef.h \
		../../include/sys/cdefs.h \
...
airspy-handler.o: input/airspy/airspy-handler.cpp ../../local/include/libairspy/airspy.h \
		../../include/stdint.h \
		../../include/features.h \
		../../include/stdc-predef.h \
		../../include/sys/cdefs.h \
