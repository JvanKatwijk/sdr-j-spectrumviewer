...
INCPATH       = -I. -I. -Iincludes -Isrc/input -I../../../../include/qt5/qwt -I../../../../local/include -Isrc/input/dabstick -Isrc/input/sdrplay -Isrc/input/airspy -I../../../../local/include/libairspy -Isrc/input/sw-elad-s1 -Isrc/input/soundcard -I../../../../include/qt5 -I../../../../include/qt5/QtWidgets -I../../../../include/qt5/QtGui -I../../../../include/qt5/QtCore -I. -I. -I../../../../lib64/qt5/mkspecs/linux-g++
...
SOURCES       = main.cpp \
		...
		src/input/soundcard/soundcard.cpp moc_viewer.cpp \
		moc_scope.cpp \
...
DIST          = ../../../../lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		sdr-j-spectrumviewer.pro viewer.h \
		...
		src/input/soundcard/soundcard.h main.cpp \
		viewer.cpp \
		src/fft.cpp \
		src/scope.cpp \
		src/input/virtual-input.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents viewer.h includes/spectrum-constants.h includes/fft.h includes/ringbuffer.h includes/spectrogramdata.h includes/scope.h src/input/virtual-input.h src/input/dabstick/dabstick.h src/input/dabstick/dongleselect.h src/input/sdrplay/sdrplay.h src/input/sdrplay/sdrplayselect.h src/input/airspy/airspy-handler.h src/input/sw-elad-s1/elad-s1.h src/input/sw-elad-s1/elad-worker.h src/input/sw-elad-s1/elad-loader.h src/input/soundcard/pa-reader.h src/input/soundcard/soundcard.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp viewer.cpp src/fft.cpp src/scope.cpp src/input/virtual-input.cpp src/input/dabstick/dabstick.cpp src/input/dabstick/dongleselect.cpp src/input/sdrplay/sdrplay.cpp src/input/sdrplay/sdrplayselect.cpp src/input/airspy/airspy-handler.cpp src/input/sw-elad-s1/elad-s1.cpp src/input/sw-elad-s1/elad-worker.cpp src/input/sw-elad-s1/elad-loader.cpp src/input/soundcard/pa-reader.cpp src/input/soundcard/soundcard.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_viewer.cpp moc_scope.cpp moc_virtual-input.cpp moc_dabstick.cpp moc_dongleselect.cpp moc_sdrplay.cpp moc_sdrplayselect.cpp moc_airspy-handler.cpp moc_elad-s1.cpp moc_elad-worker.cpp moc_pa-reader.cpp moc_soundcard.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_viewer.cpp moc_scope.cpp moc_virtual-input.cpp moc_dabstick.cpp moc_dongleselect.cpp moc_sdrplay.cpp moc_sdrplayselect.cpp moc_airspy-handler.cpp moc_elad-s1.cpp moc_elad-worker.cpp moc_pa-reader.cpp moc_soundcard.cpp
moc_viewer.cpp: includes/spectrum-constants.h \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/includes -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/src/input -I/usr/include/qt5/qwt -I/usr/local/include -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/src/input/dabstick -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/src/input/sdrplay -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/src/input/airspy -I/usr/local/include/libairspy -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/src/input/sw-elad-s1 -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/src/input/soundcard -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/6.2.1 -I/usr/include/c++/6.2.1/x86_64-redhat-linux -I/usr/include/c++/6.2.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/6.2.1/include -I/usr/local/include -I/usr/include viewer.h -o moc_viewer.cpp
