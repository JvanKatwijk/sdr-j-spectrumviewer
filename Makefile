...
CC            = gcc
CXX           = g++
DEFINES       = -DGITHASH=\"74e2034\" -DHAVE_RTLSDR -DHAVE_SDRPLAY -DHAVE_AIRSPY -DHAVE_SOUNDCARD -DHAVE_HACKRF -DHAVE_LIME -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
