...
CC            = gcc
CXX           = g++
DEFINES       = -DGITHASH=\"523bae4\" -DHAVE_RTLSDR -DHAVE_SDRPLAY -DHAVE_PLUTO -DHAVE_AIRSPY -DHAVE_SOUNDCARD -DHAVE_HACKRF -DHAVE_LIME -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -I. -Isrc -Idevices -I../../../../include/qt5/qwt -I../../../../local/include -Idevices/rtlsdr-handler -Idevices/sdrplay-handler -Idevices/pluto-handler -Idevices/airspy-handler -Idevices/airspy-handler/libairspy -Idevices/soundcard -Idevices/hackrf-handler -Idevices/lime-handler -I../../../../include/qt5 -I../../../../include/qt5/QtWidgets -I../../../../include/qt5/QtGui -I../../../../include/qt5/QtNetwork -I../../../../include/qt5/QtCore -I. -I../../../../include/libdrm -I. -I../../../../lib64/qt5/mkspecs/linux-g++
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lqwt-qt5 -lusb-1.0 -lrt -lfftw3f -ldl -lsndfile -lsamplerate -liio -lad9361 -lportaudio /usr/lib64/libQt5Widgets.so /usr/lib64/libQt5Gui.so /usr/lib64/libQt5Network.so /usr/lib64/libQt5Core.so /usr/lib64/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
linux-bin/spectrumviewer: ui_sdrgui.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_pluto-widget.h ui_airspy-widget.h ui_soundcard-widget.h ui_hackrf-widget.h ui_lime-widget.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents viewer.h src/fft.h src/ringbuffer.h src/spectrogramdata.h src/spectrum-scope.h src/signal-viewer.h src/waterfall-scope.h src/mapper.h src/decimator.h src/popup-keypad.h src/fir-filters.h devices/device-handler.h devices/rtlsdr-handler/rtlsdr-handler.h devices/rtlsdr-handler/dongleselect.h devices/sdrplay-handler/sdrplay-handler.h devices/sdrplay-handler/sdrplayselect.h devices/pluto-handler/pluto-handler.h devices/airspy-handler/airspy-handler.h devices/soundcard/pa-reader.h devices/soundcard/soundcard.h devices/hackrf-handler/hackrf-handler.h devices/lime-handler/lime-handler.h devices/lime-handler/lime-reader.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp viewer.cpp src/mapper.cpp src/fft.cpp src/spectrum-scope.cpp src/signal-viewer.cpp src/waterfall-scope.cpp src/decimator.cpp src/popup-keypad.cpp src/fir-filters.cpp devices/device-handler.cpp devices/rtlsdr-handler/rtlsdr-handler.cpp devices/rtlsdr-handler/dongleselect.cpp devices/sdrplay-handler/sdrplay-handler.cpp devices/sdrplay-handler/sdrplayselect.cpp devices/pluto-handler/pluto-handler.cpp devices/airspy-handler/airspy-handler.cpp devices/soundcard/pa-reader.cpp devices/soundcard/soundcard.cpp devices/hackrf-handler/hackrf-handler.cpp devices/lime-handler/lime-handler.cpp devices/lime-handler/lime-reader.cpp $(DISTDIR)/
	$(COPY_FILE) --parents sdrgui.ui devices/rtlsdr-handler/dabstick-widget.ui devices/sdrplay-handler/sdrplay-widget.ui devices/pluto-handler/pluto-widget.ui devices/airspy-handler/airspy-widget.ui devices/soundcard/soundcard-widget.ui devices/hackrf-handler/hackrf-widget.ui devices/lime-handler/lime-widget.ui $(DISTDIR)/
...
moc_viewer.cpp: viewer.h \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include /usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/src -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices -I/usr/include/qt5/qwt -I/usr/local/include -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/rtlsdr-handler -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/sdrplay-handler -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/pluto-handler -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/airspy-handler -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/airspy-handler/libairspy -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/soundcard -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/hackrf-handler -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/lime-handler -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I/usr/include/c++/9 -I/usr/include/c++/9/x86_64-redhat-linux -I/usr/include/c++/9/backward -I/usr/lib/gcc/x86_64-redhat-linux/9/include -I/usr/local/include -I/usr/include viewer.h -o moc_viewer.cpp
...
moc_pluto-handler.cpp: devices/pluto-handler/pluto-handler.h \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include /usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/src -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices -I/usr/include/qt5/qwt -I/usr/local/include -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/rtlsdr-handler -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/sdrplay-handler -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/pluto-handler -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/airspy-handler -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/airspy-handler/libairspy -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/soundcard -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/hackrf-handler -I/usr/shared/sdr-j-development/systems/sdr-j-spectrumviewer/devices/lime-handler -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I/usr/include/c++/9 -I/usr/include/c++/9/x86_64-redhat-linux -I/usr/include/c++/9/backward -I/usr/lib/gcc/x86_64-redhat-linux/9/include -I/usr/local/include -I/usr/include devices/pluto-handler/pluto-handler.h -o moc_pluto-handler.cpp
...
compiler_uic_make_all: ui_sdrgui.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_pluto-widget.h ui_airspy-widget.h ui_soundcard-widget.h ui_hackrf-widget.h ui_lime-widget.h
compiler_uic_clean:
	-$(DEL_FILE) ui_sdrgui.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_pluto-widget.h ui_airspy-widget.h ui_soundcard-widget.h ui_hackrf-widget.h ui_lime-widget.h
...
ui_pluto-widget.h: devices/pluto-handler/pluto-widget.ui \
		../../../../lib64/qt5/bin/uic
	/usr/lib64/qt5/bin/uic devices/pluto-handler/pluto-widget.ui -o ui_pluto-widget.h
...
pluto-handler.o: devices/pluto-handler/pluto-handler.cpp ../../../../include/qt5/QtCore/QThread \
		../../../../include/qt5/QtCore/qthread.h \
		../../../../include/qt5/QtCore/qobject.h \
		../../../../include/qt5/QtCore/qobjectdefs.h \
		../../../../include/qt5/QtCore/qnamespace.h \
		...
		../../../../include/qt5/QtWidgets/QVBoxLayout \
		../../../../include/qt5/QtWidgets/QWidget \
		../../../../local/include/ad9361.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pluto-handler.o devices/pluto-handler/pluto-handler.cpp
...
moc_pluto-handler.o: moc_pluto-handler.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_pluto-handler.o moc_pluto-handler.cpp
