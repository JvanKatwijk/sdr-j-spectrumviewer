...
#include	"spectrum-constants.h"	// some general definitions
...
int	err;
	...
	functions	-> my_mir_sdr_SetParam (105, 1);	// IQ Corr
	while (runnable) {
	   err =  functions ->
...
void	sdrplayWorker::setGain		(int16_t gain) {
...
void	sdrplayWorker::setRate		(int32_t newRate) {
